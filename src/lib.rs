...
#[derive(Debug)]
pub struct ProNanoProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ProNanoProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ProNano processing");
    
    let mut processor = ProNanoProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ProNanoProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ProNanoProcessor::new(false);
